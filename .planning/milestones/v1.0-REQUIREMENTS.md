...
- [x] **REPO-03**: User can view repository files, branches, and commit history in the web UI
...
### Code Review
- [x] **CODE-01**: User can open a Pull Request from one branch to another
- [x] **CODE-02**: User can view the diff of a Pull Request
- [x] **CODE-03**: User can leave comments on a Pull Request and merge it
