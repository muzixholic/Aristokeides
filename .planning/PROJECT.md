...
- **Current Milestone: v1.1 (SSH & Advanced Code Review)**
- **Goal:** 기존 Git 호스팅과 PR 시스템의 확장으로, SSH 연동 및 고도화된 라인 단위 코드 리뷰 기능을 제공합니다.
- **Target features:**
  - SSH Git 지원 (SSH Key 관리, SSH 프로토콜 기반 Git Clone/Push/Pull)
  - 라인 단위 코드 리뷰 (PR Diff 화면에서 라인별 코멘트 및 리뷰 추가)
...
---
*Last updated: 2026-06-02 after milestone v1.1 start*
