        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequireSignedCommits = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsPrivate = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    PrimaryLanguage = table.Column<string>(type: "longtext", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    CommitHash = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    RepositoryId = table.Column<Guid>(type: "char(36)", nullable: false),
                    SignerUserId = table.Column<int>(type: "int", nullable: true),
                    Status = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    Algorithm = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    KeyFingerprint = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    IssueId = table.Column<Guid>(type: "char(36)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MergeCommitSha = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldLineNumber = table.Column<int>(type: "int", nullable: true),
                    NewLineNumber = table.Column<int>(type: "int", nullable: true),
                    LineType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    DiffHunk = table.Column<string>(type: "longtext", nullable: true),
                    Content = table.Column<string>(type: "longtext", nullable: false),
